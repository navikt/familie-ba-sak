...
CREATE UNIQUE INDEX UIDX_ETTERBETALING_KORRIGERING_FK_BEHANDLING_ID_AKTIV ON ETTERBETALING_KORRIGERING (FK_BEHANDLING_ID) where AKTIV=true;
CREATE INDEX on ETTERBETALING_KORRIGERING (fk_behandling_id);