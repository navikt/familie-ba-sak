...
INSERT INTO po_sivilstand (ID, fom, type, opprettet_av, opprettet_tid)
SELECT nextval('po_sivilstand_seq'), null, sivilstand,opprettet_av, opprettet_tid FROM po_person;