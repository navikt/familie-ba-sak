...
-- Burde disse skje i egen deploy? (og bruk av aktivert tid og, ellers må denne deployes utenfor arbeidstid)
UPDATE behandling SET aktivert_tid = opprettet_tid;
ALTER TABLE behandling ALTER COLUMN aktivert_tid SET NOT NULL;
