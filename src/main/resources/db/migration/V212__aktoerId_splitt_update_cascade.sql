...
ALTER TABLE personident
    DROP CONSTRAINT fk_personident;
...
ALTER TABLE person_resultat
    DROP CONSTRAINT fk_person_resultat;
...
ALTER TABLE andel_tilkjent_ytelse
    DROP CONSTRAINT fk_andel_tilkjent_ytelse;
...
ALTER TABLE foedselshendelse_pre_lansering
    DROP CONSTRAINT fk_foedselshendelse_pre_lansering;
...
ALTER TABLE gr_periode_overgangsstonad
    DROP CONSTRAINT fk_gr_periode_overgangsstonad;
...
ALTER TABLE aktoer_til_kompetanse
    DROP CONSTRAINT aktoer_til_kompetanse_fk_aktoer_id_fkey;
...
ALTER TABLE aktoer_til_utenlandsk_periodebeloep
    DROP CONSTRAINT aktoer_til_utenlandsk_periodebeloep_fk_aktoer_id_fkey;
...
ALTER TABLE aktoer_til_valutakurs
    DROP CONSTRAINT aktoer_til_valutakurs_fk_aktoer_id_fkey;
