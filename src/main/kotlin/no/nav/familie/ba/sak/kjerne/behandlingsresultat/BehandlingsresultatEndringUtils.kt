    ...
    internal fun utledEndringsresultat(
        ...
        val endringerForRelevantePersoner =
            relevantePersoner.any { aktør ->
                ...
                val nåværendeEndretAndelerForPerson = nåværendeEndretAndeler.filter { it.personer.any { it.aktør == aktør } }
                val forrigeEndretAndelerForPerson = forrigeEndretAndeler.filter { it.personer.any { it.aktør == aktør } }
