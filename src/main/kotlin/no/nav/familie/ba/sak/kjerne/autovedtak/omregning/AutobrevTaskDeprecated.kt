...
@Service
@TaskStepBeskrivelse(
    taskStepType = AutobrevTaskDeprecated.TASK_STEP_TYPE,
    beskrivelse = "Opprett oppgaver for sending av autobrev",
    maxAntallFeil = 3,
    triggerTidVedFeilISekunder = (60 * 60 * 24).toLong()
)
@Deprecated("Kan slettes når alle tasker med navn FinnAlleBarn6og18ÅrTask er kjørt")
class AutobrevTaskDeprecated(
    ...
    companion object {
        ...
        private val logger: Logger = LoggerFactory.getLogger(AutobrevTaskDeprecated::class.java)
    }
}
