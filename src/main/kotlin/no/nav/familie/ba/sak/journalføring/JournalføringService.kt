...
class JournalføringService(private val integrasjonClient: IntegrasjonClient,
    ...
    fun ferdigstill(request: OppdaterJournalpostRequest,
    ...
    private fun oppdaterOgFerdigstillJournalpostPlusOppgave(request: OppdaterJournalpostRequest,
                                                            journalpostId: String,
                                                            behandlendeEnhet: String,
                                                            oppgaveId: String) {
    ...
    private fun opprettNyBehandling(request: OppdaterJournalpostRequest, journalpostId: String): Long {
        ...
        val underkategori = when (request.behandlingstema) {
            UTVIDET_BARNETRYGD.kode -> BehandlingUnderkategori.UTVIDET
