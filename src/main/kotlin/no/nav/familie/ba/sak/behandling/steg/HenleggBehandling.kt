...
class HenleggBehandling(
    ...
    override fun utførStegOgAngiNeste(behandling: Behandling,
        ...
        val sisteBehandlingSteg = behandlingStegTilstandRepository.finnSisteBehandlingStegTilstand(behandling.id)



        if (behandling.status. == BehandlingStatus.HENLEGG) {
            error("Behandlingen er allerede henlagt")
