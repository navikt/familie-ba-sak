...
data class DagTidspunkt internal constructor(
    ...
    companion object {
        ...
        internal fun LocalDate?.tilTidspunktEllerTidligereEnn() =
            tilTidspunktEllerUendelig(this ?: LocalDate.now(), Uendelighet.FORTID)

        internal fun LocalDate?.tilTidspunktEllerSenereEnn() =
            tilTidspunktEllerUendelig(this ?: LocalDate.now(), Uendelighet.FREMTID)
