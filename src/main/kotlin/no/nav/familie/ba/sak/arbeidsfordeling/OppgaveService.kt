...
@Service
class OppgaveService(private val integrasjonOnBehalfClient: IntegrasjonOnBehalfClient,
    ...
    fun opprettOppgaveForNyBehandling(behandlingsId: Long): String {
        ...
        val aktørId = integrasjonOnBehalfClient.hentAktørId(behandling.fagsak.personIdent.ident).id
        ...
        val opprettetOppgaveId = integrasjonOnBehalfClient.opprettOppgave(opprettOppgave)
    ...
    fun ferdigstillOppgave(behandlingsId: Long) {
        ...
        integrasjonOnBehalfClient.ferdigstillOppgave(oppgaveId)
    }
