...
object TilkjentYtelseValidering {
    ...
    fun validerAtBarnIkkeFårFlereUtbetalingerSammePeriode(
        ...
        if (barnMedUtbetalingsikkerhetFeil.isNotEmpty()) {
            val relevantFagsakOgBehandling =
                barnMedAndreRelevanteTilkjentYtelser
                    .flatMap { it.second }
            ...
            throw UtbetalingsikkerhetFeil(
                ...
                }. ${if (relevantFagsakOgBehandling.isNotEmpty()) "Sammenligning gjort med ${relevantFagsakOgBehandling.joinToString(",") { it }}. Mulig det finnes behandlinger som ligger til godkjenning som vil korrigere feilen." else ""}",
