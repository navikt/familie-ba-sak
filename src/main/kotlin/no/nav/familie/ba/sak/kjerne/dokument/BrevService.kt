...
class BrevService(
    ...
    fun hentVedtaksbrevData(vedtak: Vedtak): Vedtaksbrev {
        ...
        return when (vedtakstype) {
            Vedtaksbrevtype.FØRSTEGANGSVEDTAK -> Førstegangsvedtak(
            ...
            Vedtaksbrevtype.OPPHØRT -> Opphørt(
                vedtakFellesfelter = vedtakFellesfelter,
            ...
            Vedtaksbrevtype.AUTOVEDTAK_BARN18_ÅR -> VedtakEndring(
                vedtakFellesfelter = vedtakFellesfelter,
                etterbetaling = null,
                erKlage = false,
    ...
    private fun verifiserVedtakHarBegrunnelse(vedtak: Vedtak) {
        if (vedtak.vedtakBegrunnelser.size == 0) {
            throw FunksjonellFeil(
                melding = "Vedtaket har ingen begrunnelser",
