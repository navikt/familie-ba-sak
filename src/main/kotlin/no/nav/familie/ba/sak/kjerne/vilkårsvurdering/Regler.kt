...
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårIkkeOppfyltÅrsak.BARNET_BOR_IKKE_MED_MOR
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårIkkeOppfyltÅrsak.BARN_ER_GIFT_ELLER_HAR_PARTNERSKAP
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårIkkeOppfyltÅrsak.BOR_IKKE_I_RIKET
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårIkkeOppfyltÅrsak.ER_IKKE_UNDER_18_ÅR
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårIkkeOppfyltÅrsak.EØS_BOR_IKKE_SAMMEN_MED_MEDFORELDER_OG_MOR_IKKE_INNFRIDD_ARBEIDSMENGDE
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårIkkeOppfyltÅrsak.EØS_BOR_IKKE_SAMMEN_MED_MEDFORELDER_OG_MOR_IKKE_INNFRIDD_BOTIDSKRAV
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårIkkeOppfyltÅrsak.EØS_IKKE_REGISTRERT_MEDFORELDER_OG_MOR_IKKE_INNFRIDD_ARBEIDSMENGDE
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårIkkeOppfyltÅrsak.EØS_IKKE_REGISTRERT_MEDFORELDER_OG_MOR_IKKE_INNFRIDD_BOTIDSKRAV
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårIkkeOppfyltÅrsak.EØS_MEDFORELDER_IKKE_I_ARBEID_OG_MOR_IKKE_INNFRIDD_ARBEIDSMENGDE
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårIkkeOppfyltÅrsak.EØS_MEDFORELDER_IKKE_I_ARBEID_OG_MOR_IKKE_INNFRIDD_BOTIDSKRAV
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårIkkeOppfyltÅrsak.EØS_MEDFORELDER_STATSLØS
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårIkkeOppfyltÅrsak.EØS_MEDFORELDER_TREDJELANDSBORGER
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårIkkeOppfyltÅrsak.STATSBORGERSKAP_ANNEN_FORELDER_UKLART
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårIkkeOppfyltÅrsak.STATSLØS
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårIkkeOppfyltÅrsak.SØKER_ER_IKKE_MOR
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårIkkeOppfyltÅrsak.TREDJELANDSBORGER_UTEN_LOVLIG_OPPHOLD
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårKanskjeOppfyltÅrsak.LOVLIG_OPPHOLD_IKKE_MULIG_Å_FASTSETTE
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårOppfyltÅrsak.ANNEN_FORELDER_EØS_MEN_MED_LØPENDE_ARBEIDSFORHOLD
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårOppfyltÅrsak.ANNEN_FORELDER_NORDISK
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårOppfyltÅrsak.AUTOMATISK_VURDERING_BARN_LOVLIG_OPPHOLD
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårOppfyltÅrsak.BARNET_BOR_MED_MOR
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårOppfyltÅrsak.BARN_ER_IKKE_GIFT_ELLER_HAR_PARTNERSKAP
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårOppfyltÅrsak.BARN_MANGLER_SIVILSTAND
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårOppfyltÅrsak.BOR_I_RIKET
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårOppfyltÅrsak.ER_UNDER_18_ÅR
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårOppfyltÅrsak.EØS_MED_LØPENDE_ARBEIDSFORHOLD
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårOppfyltÅrsak.MOR_BODD_OG_JOBBET_I_NORGE_SISTE_5_ÅR
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårOppfyltÅrsak.NORDISK_STATSBORGER
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårOppfyltÅrsak.SØKER_ER_MOR
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårOppfyltÅrsak.TREDJELANDSBORGER_MED_LOVLIG_OPPHOLD
import no.nav.familie.ba.sak.kjerne.automatiskvurdering.vilkårsvurdering.utfall.VilkårOppfyltÅrsak.UKJENT_STATSBORGERSKAP_MED_LOVLIG_OPPHOLD
