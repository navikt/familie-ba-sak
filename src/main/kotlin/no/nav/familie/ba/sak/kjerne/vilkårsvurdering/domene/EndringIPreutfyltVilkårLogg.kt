...
data class EndringIPreutfyltVilkårLogg(
    ...
    val forrigeVurderes_etter: Regelverk?,
    @Enumerated(EnumType.STRING)
    @Column(name = "ny_vurderes_etter")
    val nyVurderes_etter: Regelverk?,
    ...
    companion object {
        fun opprettLoggForEndringIPreutfyltVilkår(
            ...
            EndringIPreutfyltVilkårLogg(
                ...
                forrigeVurderes_etter = forrigeVilkår.vurderesEtter,
                nyVurderes_etter = nyttVilkår.vurderesEtter,
