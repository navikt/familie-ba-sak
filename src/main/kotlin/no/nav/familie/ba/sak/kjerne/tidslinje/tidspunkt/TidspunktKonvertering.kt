...
fun <T : Tidsenhet> Tidspunkt<T>.tilFørsteDagIMåneden() =
    when (this) {
...
fun <T : Tidsenhet> Tidspunkt<T>.tilSisteDagIMåneden() =
    when (this) {
...
fun <T : Tidsenhet> Tidspunkt<T>.tilInneværendeMåned() =
    when (this) {
...
fun <T : Tidsenhet> Tidspunkt<T>.tilNesteMåned() =
    when (this) {
...
fun <T : Tidsenhet> Tidspunkt<T>.tilForrigeMåned() =
    when (this) {
...
fun <T : Tidsenhet> Tidspunkt<T>.tilDagEllerFørsteDagIPerioden() =
    when (this) {
...
fun <T : Tidsenhet> Tidspunkt<T>.tilDagEllerSisteDagIPerioden() =
    when (this) {
        is DagTidspunkt -> this
...
fun <T : Tidsenhet> Tidspunkt<T>.somFraOgMed() =
    when (uendelighet) {
        Uendelighet.FREMTID -> medUendelighet(Uendelighet.INGEN)
        else -> this
    }

fun <T : Tidsenhet> Tidspunkt<T>.somTilOgMed() =
    when (uendelighet) {
