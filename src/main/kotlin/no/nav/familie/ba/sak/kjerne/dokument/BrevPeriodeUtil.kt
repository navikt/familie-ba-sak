...
fun vedtaksperioderTilBrevPerioder(
    ...
    grupperteAvslagsbegrunnelser: Map<NullablePeriode, List<String>>
) = vedtaksperioder
        ...
        if (vedtaksperiode is Utbetalingsperiode) {
            ...
            val begrunnelser =
                filtrerBegrunnelserForPeriodeOgVedtaksbegrunnelsetype(
                    vedtakbegrunnelser, vedtaksperiode,
                    listOf(
            ...
            val begrunnelserAvslag =
                grupperteAvslagsbegrunnelser.getValue(
                    NullablePeriode(
...
private fun filtrerBegrunnelserForPeriodeOgVedtaksbegrunnelsetype(
    vedtakBegrunnelser: MutableSet<VedtakBegrunnelse>,
