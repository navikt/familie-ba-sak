...
@Component
class Autobrev3og6og18ÅrScheduler(val taskRepository: TaskRepositoryWrapper) {

    /*
     * Hver måned skal løpende fagsaker med barn som fyller 3-, 6- eller 18 år i løpet av måneden slås opp og tasker for å sjekke om
    ...
    fun opprettTaskAutoBrev3og6og18år() {
    ...
    companion object {
        ...
        private val logger = LoggerFactory.getLogger(Autobrev3og6og18ÅrScheduler::class.java)
