...
enum class Brevmal(val erVedtaksbrev: Boolean, val apiNavn: String, val visningsTekst: String) {
    ...
    INFORMASJONSBREV_OM_VALUTAJUSTERING(
        erVedtaksbrev = false,
        apiNavn = "informasjonOmValutajusteringAvBarnetrygden",
        visningsTekst = "Informasjon om valutajustering",
    ),
    ...
    fun tilFamilieKontrakterDokumentType(): Dokumenttype =
        when (this) {
            ...
            INFORMASJONSBREV_OM_VALUTAJUSTERING -> Dokumenttype.BARNETRYGD_INFORMASJONSBREV_OM_VALUTAJUSTERING
    ...
    val distribusjonstype: Distribusjonstype
        get() =
            when (this) {
                ...
                INFORMASJONSBREV_OM_VALUTAJUSTERING -> Distribusjonstype.VIKTIG
