...
enum class Brevmal(
    ...
    fun tilFamilieKontrakterDokumentType(): Dokumenttype =
        when (this) {
            ...
            INFORMASJONSBREV_TIL_FORELDER_OMFATTET_NORSK_LOVGIVNING_HENTER_IKKE_REGISTEROPPLYSNINGER -> Dokumenttype.BARBETRYGD_INFORMASJONSBREV_TIL_FORELDER_OMFATTET_NORSK_LOVGIVNING_HENTER_IKKE_REGISTEROPPLYSNINGER
