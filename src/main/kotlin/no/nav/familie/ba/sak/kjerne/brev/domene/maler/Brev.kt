...
enum class Brevmal(
    ...
    fun tilFamilieKontrakterDokumentType(): Dokumenttype =
        when (this) {
            ...
            INFORMASJONSBREV_KAN_HA_RETT_TIL_PENGESTØTTE_FRA_NAV -> Dokumenttype.BARNETRYGD_INFORMASJONSBREV_TIL_FORELDER_OMFATTET_NORSK_LOVGIVNING_HENTER_IKKE_REGISTEROPPLYSNINGER
