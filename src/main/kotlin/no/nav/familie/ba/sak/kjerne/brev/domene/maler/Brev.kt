...
enum class Brevmal(
    ...
    INFORMASJONSBREV_INNHENTE_OPPLYSNINGER_KLAGE_INSTITUSJON(
        erVedtaksbrev = false,
        apiNavn = "innhenteOpplysningerKlageInstitusjon",
        visningsTekst = "Innhente opplysninger klage institusjon",
    ),
    ...
    fun tilFamilieKontrakterDokumentType(): Dokumenttype =
        when (this) {
            ...
            INFORMASJONSBREV_TIL_FORELDER_OMFATTET_NORSK_LOVGIVNING_HENTER_IKKE_REGISTEROPPLYSNINGER -> Dokumenttype.BARNETRYGD_INFORMASJONSBREV_TIL_FORELDER_OMFATTET_NORSK_LOVGIVNING_HENTER_IKKE_REGISTEROPPLYSNINGER

            INFORMASJONSBREV_KAN_HA_RETT_TIL_PENGESTØTTE_FRA_NAV -> Dokumenttype.BARNETRYGD_INFORMASJONSBREV_KAN_HA_RETT_TIL_PENGESTØTTE_FRA_NAV

            INFORMASJONSBREV_INNHENTE_OPPLYSNINGER_KLAGE -> Dokumenttype.BARNETRYGD_INFORMASJONSBREV_INNHENTE_OPPLYSNINGER_KLAGE

            INFORMASJONSBREV_INNHENTE_OPPLYSNINGER_KLAGE_INSTITUSJON -> Dokumenttype.BARNETRYGD_INFORMASJONSBREV_INNHENTE_OPPLYSNINGER_KLAGE_INSTITUSJON
