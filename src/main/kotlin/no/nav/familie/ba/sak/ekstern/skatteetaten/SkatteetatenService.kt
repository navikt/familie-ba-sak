...
class SkatteetatenService(private val infotrygdBarnetrygdClient: InfotrygdBarnetrygdClient) {
    ...
    fun finnPersonerMedUtvidetBarnetrygd(år: Int): SkatteetatenPersonerResponse {
    ...
    fun finnPerioderMedUtvidetBarnetrygd(personer: List<String>, år: Int): SkatteetatenPerioderResponse {
        val perioderFraInfotrygd = personer.map { infotrygdBarnetrygdClient.hentPerioderMedUtvidetBarnetrygd(it, år) }
