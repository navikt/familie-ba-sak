...
enum class VedtakBegrunnelse(val tittel: String) : IVedtakBegrunnelse {
    ...
    INNVILGET_LOVLIG_OPPHOLD_SKJØNNSMESSIG_VURDERING_TREDJELANDSBORGER("Skjønnsmessig vurdering tålt opphold tredjelandsborger") {
        ...
        override fun hentBeskrivelse(
            ...
            Målform.NB -> "Du får barnetrygd fordi vi har kommet fram til at du har oppholdsrett fra $vilkårsdato."
            Målform.NN -> "Du får barnetrygd fordi vi har kome fram til at du har opphaldsrett frå $vilkårsdato."
        }
    },
    ...
    INNVILGET_MEDLEM_I_FOLKETRYGDEN("Medlem i Folketrygden") {
        ...
        override fun hentBeskrivelse(
            ...
            Målform.NB -> "Du får barnetrygd fordi du er medlem i Norsk Folketrygd fra $vilkårsdato."
            Målform.NN -> "Du får barnetrygd fordi du er medlem i Norsk Folketrygd frå $vilkårsdato."
        }
    },
