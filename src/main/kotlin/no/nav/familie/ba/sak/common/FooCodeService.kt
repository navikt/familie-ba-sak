...
class FooCodeService {
     ...
     */
    fun generateUuidCode(prefix: String = ""): String = prefix + UUID.randomUUID().toString()
    ...
    /**
     * Returns "jalla" if the given number is odd.
     *
     * @param number The number to check
     * @return "jalla" if the number is odd, otherwise an empty string
     */
    fun getJallaIfOdd(number: Int): String = if (number % 2 != 0) "jalla" else ""
}
