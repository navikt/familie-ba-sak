...
/*
fun VilkårResultat.toPeriode(): Periode = when {
    this.periodeFom !== null -> {
        Periode(fom = this.periodeFom,
                tom = this.periodeTom ?: TIDENES_ENDE)
    }
    this.erEksplisittAvslagPåSøknad == true && this.periodeTom == null -> {
...
fun RestVilkårResultat.toPeriode(): Periode = when {
    this.periodeFom !== null -> {
        Periode(fom = this.periodeFom,
                tom = this.periodeTom ?: TIDENES_ENDE)
    }
