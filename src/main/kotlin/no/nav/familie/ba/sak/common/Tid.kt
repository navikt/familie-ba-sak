...
fun LocalDate.erFraInneværendeMåned(now: LocalDate = LocalDate.now()): Boolean {
...
fun LocalDate.erFraInneværendeEllerForrigeMåned(now: LocalDate = LocalDate.now()): Boolean {
