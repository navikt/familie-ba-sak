...
Egenskap: Gyldige begrunnelser for fagsaktype
  ...
  Scenario: Skal ikke gi institusjonsbegrunnelser når vi har normal fagsak
    ...
    Og lag personresultater for behandling 100175168

    Og legg til nye vilkårresultater for behandling 100175168
  ...
  Scenario: Skal gi institusjonsbegrunnelser for institusjonssak
    ...
    Og lag personresultater for behandling 100175169

    Og legg til nye vilkårresultater for behandling 100175169
      | AktørId       | Vilkår                                        | Utdypende vilkår | Fra dato   | Til dato   | Resultat | Er eksplisitt avslag |
