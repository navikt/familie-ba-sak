...
Egenskap: Utbetalingsoppdrag: Automatisk revurdering med årsak OPPDATER_UTVIDET_KLASSEKODE
  ...
  Scenario: Skal sende kjedelementer for utvidet andel fra inneværende måned og fremover i tid når inneværende måned treffer midt i en andel
    ...
    Så forvent følgende utbetalingsoppdrag
      ...
      | 2            | 12.2024  | 05.2025  |             | 700   | ENDR         | Nei        | 1          | 0                  | UTVIDET_BARNETRYGD        |

  Scenario: Skal ikke sende kjedelementer for utvidet andel når inneværende måned treffer i en andel og andelen også slutter inneværende måned
  ...
  Scenario: Skal sende kjedelementer for alle utvidet andeler fra inneværende måned og fremover i tid når inneværende måned treffer midt i en andel
    ...
    Så forvent følgende utbetalingsoppdrag
      ...
      | 2            | 06.2025  | 12.2025  |             | 850   | ENDR         | Nei        | 3          | 2                  | UTVIDET_BARNETRYGD        |
