...
Egenskap: Gyldige begrunnelser for opphør fra forrige behandling
  ...
  Scenario: Skal gi opphør fra forrige behandling-begrunnelser for eøs-begrunnelser også
    Og lag personresultater for begrunnelse for behandling 1
    Og lag personresultater for begrunnelse for behandling 2
    ...
    Og med kompetanser for begrunnelse
      ...
      | 3456    | 01.10.2019 | 12.12.2022 | NORGE_ER_SEKUNDÆRLAND | 1            | I_ARBEID                  | PL                  |
      | 3456    | 01.10.2020 | 12.12.2022 | NORGE_ER_SEKUNDÆRLAND | 2            | I_ARBEID                  | PL                  |
    ...
    Så forvent at følgende begrunnelser er gyldige
      | Fra dato   | Til dato   | VedtaksperiodeType | Regelverk | Gyldige begrunnelser               | Ugyldige begrunnelser                 |
      | 01.10.2019 | 01.10.2020 | OPPHØR             |           | OPPHOR_SOKER_BODDE_IKKE_I_EOS_LAND | OPPHØR_AVTALE_DELT_BOSTED_IKKE_GYLDIG |
      | 01.10.2020 | 31.08.2021 | UTBETALING         |           |                                    |                                       |
      | 01.09.2021 | 31.12.2021 | UTBETALING         |           |                                    |                                       |
      | 01.01.2022 |            | OPPHØR             |           |                                    |                                       |
