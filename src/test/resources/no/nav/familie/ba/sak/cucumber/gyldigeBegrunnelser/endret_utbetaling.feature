...
Egenskap: Gyldige begrunnelser for endret utbetaling
  ...
  Scenario: Begrunnelse etter endret utbetaling ETTERBETALING_3ÅR
    ...
    Så forvent at følgende begrunnelser er gyldige
      | Fra dato   | Til dato   | VedtaksperiodeType | Gyldige begrunnelser                          | Ugyldige begrunnelser                             |
      | 01.02.2021 | 31.03.2038 | UTBETALING         | ETTER_ENDRET_UTBETALING_ETTERBETALING_TRE_AAR | ETTER_ENDRET_UTBETALING_ETTERBETALING_TRE_MÅNEDER |
      | 01.04.2038 |            | OPPHØR             | OPPHØR_UNDER_18_ÅR                            |                                                   |

  Scenario: Begrunnelse etter endret utbetaling ETTERBETALING_3MND
    Og lag personresultater for behandling 1
    ...
    Og med endrede utbetalinger
      | AktørId | Fra dato   | Til dato   | BehandlingId | Årsak              | Prosent |
      | 3456    | 01.05.2020 | 31.01.2021 | 1            | ETTERBETALING_3MND | 0       |
    ...
    Så forvent at følgende begrunnelser er gyldige
      | Fra dato   | Til dato   | VedtaksperiodeType | Gyldige begrunnelser                              | Ugyldige begrunnelser                         |
      | 01.02.2021 | 31.03.2038 | UTBETALING         | ETTER_ENDRET_UTBETALING_ETTERBETALING_TRE_MÅNEDER | ETTER_ENDRET_UTBETALING_ETTERBETALING_TRE_AAR |
      | 01.04.2038 |            | OPPHØR             | OPPHØR_UNDER_18_ÅR                                |                                               |
  ...
  Scenario: Endret utbetaling tre år tilbake i tid til 50 % etter at delt bosted er fjernet, fordi endringen ble søkt om for sent
    ...
    Så forvent at følgende begrunnelser er gyldige
      | Fra dato   | Til dato   | VedtaksperiodeType | Regelverk Gyldige begrunnelser | Gyldige begrunnelser                              | Ugyldige begrunnelser                                  |
      | 01.06.2015 | 28.02.2019 | UTBETALING         |                                | ENDRET_UTBETALING_TRE_ÅR_TILBAKE_I_TID_UTBETALING | ENDRET_UTBETALING_TRE_MÅNEDER_TILBAKE_I_TID_UTBETALING |
      | 01.03.2019 | 31.10.2020 | UTBETALING         |                                | ENDRET_UTBETALING_TRE_ÅR_TILBAKE_I_TID_UTBETALING | ENDRET_UTBETALING_TRE_MÅNEDER_TILBAKE_I_TID_UTBETALING |
      | 01.11.2020 | 28.02.2023 | UTBETALING         |                                | ETTER_ENDRET_UTBETALING_ETTERBETALING_TRE_AAR     | ETTER_ENDRET_UTBETALING_ETTERBETALING_TRE_MÅNEDER      |

  Scenario: Endret utbetaling tre mnd tilbake i tid til 50 % etter at delt bosted er fjernet, fordi endringen ble søkt om for sent
    Gitt følgende fagsaker
      | FagsakId | Fagsaktype |
      | 1        | NORMAL     |
    ...
    Og med endrede utbetalinger
      | AktørId | BehandlingId | Fra dato   | Til dato   | Årsak              | Prosent | Søknadstidspunkt | Avtaletidspunkt delt bosted |
      | 2       | 2            | 01.06.2015 | 31.10.2020 | ETTERBETALING_3MND | 50      | 11.10.2023       |                             |

    Når vedtaksperiodene genereres for behandling 2

    Så forvent at følgende begrunnelser er gyldige
      | Fra dato   | Til dato   | VedtaksperiodeType | Regelverk Gyldige begrunnelser | Gyldige begrunnelser                                   | Ugyldige begrunnelser                             |
      | 01.06.2015 | 28.02.2019 | UTBETALING         |                                | ENDRET_UTBETALING_TRE_MÅNEDER_TILBAKE_I_TID_UTBETALING | ENDRET_UTBETALING_TRE_ÅR_TILBAKE_I_TID_UTBETALING |
      | 01.03.2019 | 31.10.2020 | UTBETALING         |                                | ENDRET_UTBETALING_TRE_MÅNEDER_TILBAKE_I_TID_UTBETALING | ENDRET_UTBETALING_TRE_ÅR_TILBAKE_I_TID_UTBETALING |
      | 01.11.2020 | 28.02.2023 | UTBETALING         |                                | ETTER_ENDRET_UTBETALING_ETTERBETALING_TRE_MÅNEDER      | ETTER_ENDRET_UTBETALING_ETTERBETALING_TRE_AAR     |
