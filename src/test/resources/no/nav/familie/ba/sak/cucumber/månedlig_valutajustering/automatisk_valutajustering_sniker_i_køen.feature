...
Egenskap: Automatisk valutajustering
  ...
  Scenario: Skalkunne kjøre automatisk valutajustering
    ...
    Og med utenlandsk periodebeløp for begrunnelse
      | AktørId | Fra dato   | Til dato | BehandlingId | Beløp | Valuta kode | Intervall | Utbetalingsland |
      | 2       | 01.11.2019 |          | 2            | 100   | DKK         | MÅNEDLIG  | NO              |

    Og med valutakurs for begrunnelse
      | AktørId | Fra dato   | Til dato | BehandlingId | Valutakursdato | Valuta kode | Kurs |
      | 2       | 01.11.2019 |          | 2            | 01.11.2019     | DKK         | 2    |

    Og med andeler tilkjent ytelse for begrunnelse
      | AktørId | BehandlingId | Fra dato   | Til dato   | Beløp | Ytelse type        | Prosent | Sats |
      | 2       | 2            | 01.11.2019 | 31.08.2020 | 854   | ORDINÆR_BARNETRYGD | 100     | 1054 |
      | 2       | 2            | 01.09.2020 | 31.08.2021 | 1154  | ORDINÆR_BARNETRYGD | 100     | 1354 |
      | 2       | 2            | 01.09.2021 | 31.12.2021 | 1454  | ORDINÆR_BARNETRYGD | 100     | 1654 |
      | 2       | 2            | 01.01.2022 | 28.02.2023 | 1476  | ORDINÆR_BARNETRYGD | 100     | 1676 |
      | 2       | 2            | 01.03.2023 | 30.06.2023 | 1523  | ORDINÆR_BARNETRYGD | 100     | 1723 |
      | 2       | 2            | 01.07.2023 | 30.09.2025 | 1566  | ORDINÆR_BARNETRYGD | 100     | 1766 |
      | 2       | 2            | 01.10.2025 | 30.09.2037 | 1310  | ORDINÆR_BARNETRYGD | 100     | 1510 |
    ...
    Når vi lager automatisk behandling med id 3 på fagsak 1 på grunn av automatisk valutajustering
