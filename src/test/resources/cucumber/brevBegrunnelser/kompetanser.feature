...
Egenskap: Brevbegrunnelser ved endring av kompetanse
  ...
  Scenario: Skal gi riktige restobjekter ved innvilget primærland
    ...
    Så forvent følgende brevbegrunnelser i rekkefølge for behandling 1 i periode 01.05.2020 til 30.04.2021
    ...
    Så forvent følgende brevbegrunnelser i rekkefølge for behandling 1 i periode 01.05.2021 til 31.03.2038
      | Begrunnelse                     | Type | Barnas fødselsdatoer | Antall barn | Målform | Annen forelders aktivitetsland | Barnets bostedsland | Søkers aktivitetsland | Annen forelders aktivitet | Søkers aktivitet | Gjelder søker |
