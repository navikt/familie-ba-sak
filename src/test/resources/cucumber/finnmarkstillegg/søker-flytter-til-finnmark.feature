...
Egenskap: Behandlig med finnmarkstillegg
  ...
  Scenario: Skal lage splitt i vedtaksperioder når det er endring i regelverk og ikke finnmarkstillegg
    Og dagens dato er 05.09.2025
    Og med personer fremstilt krav for
      | BehandlingId | AktørId |
      | 1            | 2       |
    ...
    Og legg til nye vilkårresultater for behandling 1
      ...
      | 1       | LOVLIG_OPPHOLD                              |                              | 31.03.1990 |            | OPPFYLT  |                  |
      | 1       | BOSATT_I_RIKET                              |                              | 08.11.2018 | 06.08.2025 | OPPFYLT  |                  |
      | 1       | BOSATT_I_RIKET                              | BOSATT_I_FINNMARK_NORD_TROMS | 07.08.2025 |            | OPPFYLT  | EØS_FORORDNINGEN |
