...
Egenskap: Finnmarkstillegg autovedtak første kjøring - brev og begrunnelse
  ...
  Bakgrunn:
    ...
    Og med følgende feature toggles
      ...
      | 2            | familie-ba-sak.skal-bruke-adressehendelseloype-for-finnmarkstillegg | Nei           |
  ...
  Scenario: Skal oppdatere vilkårresultater og generere andeler når autovedtak finnmarkstillegg kjøres
    ...
    Og med andeler tilkjent ytelse
      ...
      | 2       | 1            | 01.02.2026 | 30.12.2042 | 2012  | 100     | ORDINÆR_BARNETRYGD |
    ...
    Så forvent følgende andeler tilkjent ytelse for behandling 2
      ...
      | 2       | 2            | 01.02.2026 | 30.12.2042 | 2012  | 100     | ORDINÆR_BARNETRYGD |
      | 2       | 2            | 01.10.2025 | 31.01.2026 | 500   | 100     | FINNMARKSTILLEGG   |
      | 2       | 2            | 01.02.2026 | 31.12.2042 | 512   | 100     | FINNMARKSTILLEGG   |
    ...
    Så forvent følgende vedtaksperioder for behandling 2
      ...
      | 01.10.2025 | 31.01.2026 | Utbetaling         | INNVILGET_FINNMARKSTILLEGG_UTEN_DATO |
      | 01.02.2026 | 31.12.2042 | Utbetaling         | INNVILGET_FINNMARKSTILLEGG_UTEN_DATO |
      | 01.01.2043 |            | Opphør             |                                      |
    ...
    Så forvent følgende brevbegrunnelser i rekkefølge for behandling 2 i periode 01.10.2025 til 31.01.2026
      ...
      | INNVILGET_FINNMARKSTILLEGG_UTEN_DATO | STANDARD | Ja            | 01.01.25             | 1           | september 2025                       |         | 2 468 |                  | SØKER_HAR_IKKE_RETT     |                             |

    Så forvent at brevmal AUTOVEDTAK_FINNMARKSTILLEGG er brukt for behandling 2