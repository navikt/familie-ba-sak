...
Egenskap: Finnmarkstillegg autovedtak
  ...
  Scenario: Skal ikke ta hensyn til perioder før cutoff datoen 01.10.2025
    ...
    Gitt følgende behandlinger
      ...
      | 1            | 1        |                     | ENDRET_UTBETALING          | FINNMARKSTILLEGG | Ja                        | NASJONAL            | AVSLUTTET         |
    ...
    Og med andeler tilkjent ytelse
      ...
      | 2       | 1            | 01.10.2025 | 31.03.2031 | 500   | FINNMARKSTILLEGG   | 100     | 500  |
      ...
      | 3       | 1            | 01.10.2025 | 31.07.2037 | 250   | FINNMARKSTILLEGG   | 50      | 500  |
      ...
      | 4       | 1            | 01.10.2025 | 31.10.2039 | 250   | FINNMARKSTILLEGG   | 50      | 500  |
      ...
      | 2       | 2            | 01.10.2025 | 31.03.2031 | 500   | FINNMARKSTILLEGG   | 100     | 500  |
      ...
      | 3       | 2            | 01.10.2025 | 31.07.2037 | 250   | FINNMARKSTILLEGG   | 50      | 500  |
      ...
      | 4       | 2            | 01.10.2025 | 31.10.2039 | 250   | FINNMARKSTILLEGG   | 50      | 500  |

    Når vedtaksperiodene genereres for behandling 2

    Så forvent at følgende begrunnelser er gyldige
      | Fra dato   | Til dato   | VedtaksperiodeType | Regelverk Gyldige begrunnelser | Gyldige begrunnelser       | Ugyldige begrunnelser |
      | 01.10.2025 | 31.03.2031 | UTBETALING         |                                | INNVILGET_FINNMARKSTILLEGG |                       |

    Og når disse begrunnelsene er valgt for behandling 2
      | Fra dato   | Til dato   | Standardbegrunnelser       | Eøsbegrunnelser | Fritekster |
      | 01.10.2025 | 31.03.2031 | INNVILGET_FINNMARKSTILLEGG |                 |            |
    ...
    Så forvent følgende brevbegrunnelser i rekkefølge for behandling 2 i periode 01.10.2025 til 31.03.2031
      ...
      | INNVILGET_FINNMARKSTILLEGG | STANDARD | JA            | 14.04.13, 18.08.19 og 01.11.21 | 3           | september 2025                       |         | 7 452 |                  | SØKER_FÅR_UTVIDET       |                             |
