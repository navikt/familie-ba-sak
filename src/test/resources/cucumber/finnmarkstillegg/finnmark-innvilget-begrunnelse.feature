...
Egenskap: Innvilget Finnmarkstillegg begrunnelse pga søker
  ...
  Scenario: Dersom det innvilges Finnmarkstillegg fordi søker flytter til Finnmark i ny behandling skal innvilgetFinnmarkstillegg-begrunnelse være gyldig
    ...
    Og legg til nye vilkårresultater for behandling 1
      ...
      | 1       | BOSATT_I_RIKET   |                              | 05.08.2015 |            | OPPFYLT  |
    ...
    Og legg til nye vilkårresultater for behandling 2
      | AktørId | Vilkår           | Utdypende vilkår             | Fra dato   | Til dato   | Resultat |
      | 1       | LOVLIG_OPPHOLD   |                              | 15.05.1985 |            | OPPFYLT  |
      | 1       | BOSATT_I_RIKET   |                              | 05.08.2015 | 14.07.2025 | OPPFYLT  |
      | 1       | BOSATT_I_RIKET   | BOSATT_I_FINNMARK_NORD_TROMS | 15.07.2025 |            | OPPFYLT  |
    ...
    Og med andeler tilkjent ytelse
      ...
      | 2       | 2            | 01.08.2025 | 31.07.2033 | 500   | FINNMARKSTILLEGG   | 100     | 500  |

    Når vedtaksperiodene genereres for behandling 2

    Så forvent at følgende begrunnelser er gyldige
      | Fra dato   | Til dato   | VedtaksperiodeType | Gyldige begrunnelser                                  | Ugyldige begrunnelser                                                        |
      | 01.08.2025 | 31.07.2033 | UTBETALING         | INNVILGET_FINNMARKSTILLEGG, INNVILGET_BOSATT_I_RIKTET | INNVILGET_FINNMARKSTILLEGG_UTEN_DATO, INNVILGET_FINNMARKSTILLEGG_INSTITUSJON |
    ...
    Så forvent følgende brevbegrunnelser i rekkefølge for behandling 2 i periode 01.08.2025 til 31.07.2033
      ...
      | INNVILGET_FINNMARKSTILLEGG | STANDARD | Ja            | 05.08.15             | 1           | juli 2025                            | 2 468 | SØKER_HAR_IKKE_RETT     |
