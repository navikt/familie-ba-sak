...
Egenskap: Behandling med finnmarkstillegg skal ikke splitte for behandlingsresultat
  ...
  Scenario: Kun søker flytter til Finnmark skal ikke gi behandlingsresultat ENDRET
    ...
    Og legg til nye vilkårresultater for behandling 2
      ...
      | 1       | BOSATT_I_RIKET                              | BOSATT_I_FINNMARK_NORD_TROMS | 09.09.2025 |            | OPPFYLT  | Nei                  |                      | NASJONALE_REGLER |
  ...
  Scenario: Kun søker flytter til Finnmark, men det er også endring i et annet utdypende vilkår skal gi behandlingsresultat ENDRET_UTEN_UTBETALING
    Og dagens dato er 15.09.2025
    Og med personer fremstilt krav for
      | BehandlingId | AktørId |
    Og lag personresultater for behandling 1
    ...
    Og legg til nye vilkårresultater for behandling 2
      ...
      | 1       | LOVLIG_OPPHOLD                              |                                                  | 09.07.1990 |            | OPPFYLT  | Nei                  |                      | NASJONALE_REGLER |
      | 1       | BOSATT_I_RIKET                              |                                                  | 22.05.2019 | 08.09.2025 | OPPFYLT  | Nei                  |                      | NASJONALE_REGLER |
      | 1       | BOSATT_I_RIKET                              | BOSATT_I_FINNMARK_NORD_TROMS, VURDERT_MEDLEMSKAP | 09.09.2025 |            | OPPFYLT  | Nei                  |                      | NASJONALE_REGLER |
  ...
  Scenario: Søker og barn flytter til Finnmark skal gi behandlingsresultat ENDRET
    ...
    Og legg til nye vilkårresultater for behandling 2
      ...
      | 2       | GIFT_PARTNERSKAP              |                              | 22.05.2019 |            | OPPFYLT  | Nei                  |                      |                  |
      | 2       | BOR_MED_SØKER, LOVLIG_OPPHOLD |                              | 22.05.2019 |            | OPPFYLT  | Nei                  |                      | NASJONALE_REGLER |
      | 2       | BOSATT_I_RIKET                |                              | 22.05.2019 | 08.09.2025 | OPPFYLT  | Nei                  |                      | NASJONALE_REGLER |
      | 2       | BOSATT_I_RIKET                | BOSATT_I_FINNMARK_NORD_TROMS | 09.09.2025 |            | OPPFYLT  | Nei                  |                      | NASJONALE_REGLER |
      | 2       | UNDER_18_ÅR                   |                              | 22.05.2019 | 21.05.2037 | OPPFYLT  | Nei                  |                      |                  |
