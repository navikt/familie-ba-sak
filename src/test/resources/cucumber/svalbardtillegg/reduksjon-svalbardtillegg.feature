...
Egenskap: Reduksjon på svalbardtillegg
  ...
  Scenario: Skal få opp reduksjonsbegrunnelse for Svalbard når søker flytter ut av Svalbard
    ...
    Og legg til nye vilkårresultater for behandling 2
      | AktørId | Vilkår                       | Utdypende vilkår   | Fra dato   | Til dato   | Resultat |
      | 1       | LOVLIG_OPPHOLD               |                    | 26.12.1992 |            | OPPFYLT  |
      | 1       | BOSATT_I_RIKET               | BOSATT_PÅ_SVALBARD | 14.06.2011 | 08.12.2025 | OPPFYLT  |
      | 1       | BOSATT_I_RIKET               |                    | 09.12.2025 |            | OPPFYLT  |
    ...
    Og med andeler tilkjent ytelse
      ...
      | 2       | 1            | 01.10.2025 | 31.05.2029 | 500   | SVALBARDTILLEGG    | 100     | 500  |

      | 2       | 2            | 01.05.2025 | 31.05.2029 | 1968  | ORDINÆR_BARNETRYGD | 100     | 1968 |
      | 2       | 2            | 01.10.2025 | 31.12.2025 | 500   | SVALBARDTILLEGG    | 100     | 500  |

    Når vedtaksperiodene genereres for behandling 2

    Så forvent at følgende begrunnelser er gyldige
      | Fra dato   | Til dato   | VedtaksperiodeType | Regelverk Gyldige begrunnelser | Gyldige begrunnelser      | Ugyldige begrunnelser |
      | 01.01.2026 | 31.05.2029 | UTBETALING         |                                | REDUKSJON_SVALBARDTILLEGG |                       |
      | 01.06.2029 |            | OPPHØR             |                                |                           |                       |

    Og når disse begrunnelsene er valgt for behandling 2
      | Fra dato   | Til dato   | Standardbegrunnelser      | Eøsbegrunnelser | Fritekster |
      | 01.01.2026 | 31.05.2029 | REDUKSJON_SVALBARDTILLEGG |                 |            |

    Så forvent følgende brevbegrunnelser i rekkefølge for behandling 2 i periode 01.01.2026 til 31.05.2029
      | Begrunnelse               | Type     | Gjelder søker | Barnas fødselsdatoer | Antall barn | Måned og år begrunnelsen gjelder for | Målform | Beløp | Søknadstidspunkt | Søkers rett til utvidet | Avtaletidspunkt delt bosted |
      | REDUKSJON_SVALBARDTILLEGG | STANDARD | Ja            |                      | 0           | desember 2025                        |         | 1 968 |                  | SØKER_HAR_IKKE_RETT     |                             |
