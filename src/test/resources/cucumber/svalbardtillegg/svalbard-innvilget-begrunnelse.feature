...
Egenskap: Innvilget Svalbardtillegg begrunnelse pga søker
  ...
  Scenario: Dersom det innvilges Svalbardtillegg fordi søker flytter til Svalbard i ny behandling skal innvilgetSvalbardtillegg-begrunnelse være gyldig
    ...
    Og legg til nye vilkårresultater for behandling 1
      ...
      | 1       | BOSATT_I_RIKET               | BOSATT_PÅ_SVALBARD | 05.08.2015 | 14.07.2025 | OPPFYLT  |
      | 1       | BOSATT_I_RIKET               |                    | 15.07.2025 |            | OPPFYLT  |

      | 2       | GIFT_PARTNERSKAP             |                    | 05.08.2015 |            | OPPFYLT  |
      | 2       | LOVLIG_OPPHOLD               |                    | 05.08.2015 |            | OPPFYLT  |
      | 2       | BOSATT_I_RIKET               | BOSATT_PÅ_SVALBARD | 05.08.2015 |            | OPPFYLT  |
      ...
      | 3       | BOSATT_I_RIKET               | BOSATT_PÅ_SVALBARD | 10.11.2024 |            | OPPFYLT  |

    Og legg til nye vilkårresultater for behandling 2
      | AktørId | Vilkår                       | Utdypende vilkår   | Fra dato   | Til dato   | Resultat |
      | 1       | LOVLIG_OPPHOLD               |                    | 15.05.1985 |            | OPPFYLT  |
      | 1       | BOSATT_I_RIKET               | BOSATT_PÅ_SVALBARD | 05.08.2015 |            | OPPFYLT  |

      | 2       | UNDER_18_ÅR                  |                    | 05.08.2015 | 04.08.2033 | OPPFYLT  |
      | 2       | BOSATT_I_RIKET               | BOSATT_PÅ_SVALBARD | 05.08.2015 | 14.07.2025 | OPPFYLT  |
      | 2       | GIFT_PARTNERSKAP             |                    | 05.08.2015 |            | OPPFYLT  |
      | 2       | BOR_MED_SØKER                |                    | 05.08.2015 |            | OPPFYLT  |
      | 2       | LOVLIG_OPPHOLD               |                    | 05.08.2015 |            | OPPFYLT  |
    ...
    Så forvent at følgende begrunnelser er gyldige
      ...
      | 01.08.2025 | 31.07.2033 | UTBETALING         |                                | INNVILGET_SVALBARDTILLEGG |                       |
      | 01.08.2025 | 31.07.2033 | UTBETALING         |                                | INNVILGET_BOSATT_I_RIKTET |                       |


    Og når disse begrunnelsene er valgt for behandling 2
      | Fra dato   | Til dato   | Standardbegrunnelser                                 | Eøsbegrunnelser | Fritekster |
      | 01.08.2025 | 31.07.2033 | INNVILGET_SVALBARDTILLEGG, INNVILGET_BOSATT_I_RIKTET |                 |            |
    ...
    Så forvent følgende brevbegrunnelser i rekkefølge for behandling 2 i periode 01.08.2025 til 31.07.2033
      ...
      | INNVILGET_BOSATT_I_RIKTET | STANDARD | Nei           | 05.08.15             | 1           | juli 2025                            |         | 1 968 |                  | SØKER_HAR_IKKE_RETT     |                             |
      | INNVILGET_SVALBARDTILLEGG | STANDARD | Ja            | 10.11.24             | 1           | juli 2025                            |         | 4 436 |                  | SØKER_HAR_IKKE_RETT     |                             |
