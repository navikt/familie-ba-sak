...
SANITY_BEGRUNNELSER_MOCK_PATH="src/test/resources/no/nav/familie/ba/sak/cucumber/gyldigeBegrunnelser/restSanityBegrunnelser"
SANITY_EØS_BEGRUNNELSER_MOCK_PATH="src/test/resources/no/nav/familie/ba/sak/cucumber/gyldigeBegrunnelser/restSanityEØSBegrunnelser"
