...
import no.nav.familie.ba.sak.kjerne.grunnlag.personopplysninger.adresser.bostedsadresse.GrBostedsadresse.Companion.sisteAdresse
...
class BehandlingIntegrationTest(
    ...
    fun `Opprett barnas beregning på vedtak`() {
        ...
        // Barn 1
        val barn1Perioder = barnOgYtelsePeriodeDtoMap[barn1Fnr]!!.sortedBy { it.stønadFom }
        ...
        // Barn 2
        val barn2Perioder = barnOgYtelsePeriodeDtoMap[barn2Fnr]!!.sortedBy { it.stønadFom }
    ...
    fun `Endre barnas beregning på vedtak`() {
        ...
        val vilkårsvurdering2 =
            Vilkårsvurdering(behandling = behandling)
        vilkårsvurdering2.personResultater =
            lagPersonResultaterForSøkerOgToBarn(
                vilkårsvurdering2,
                søkerAktørId,
                barn1AktørId,
        ...
        // Barn 3
        val barn3perioder = barnOgYtelsePeriodeDtoMap[barn3Fnr]!!.sortedBy { it.stønadFom }
