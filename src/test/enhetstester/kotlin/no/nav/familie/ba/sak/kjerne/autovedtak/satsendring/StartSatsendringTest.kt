...
internal class StartSatsendringTest {
    ...
    fun setUp() {
        ...
        val opprettTaskService = OpprettTaskService(taskRepository = taskRepository, satskjøringRepository = satskjøringRepository, envService = mockk(), featureToggleService = mockk(), svalbardtilleggKjøringRepository = mockk())
