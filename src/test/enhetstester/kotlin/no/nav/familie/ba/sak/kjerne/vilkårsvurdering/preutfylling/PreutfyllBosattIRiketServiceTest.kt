...
class PreutfyllBosattIRiketServiceTest {
    ...
    @Nested
    inner class GenererBosattIRiketVilkårResultatForFinnmarkOgSvalbardtillegg {
        @Test
        fun `skal generere bosatt i riket vilkår for person som har oppholdsadresse på Svalbard`() {
            ...
            // Act
            val preutfylt =
                preutfyllBosattIRiketService.genererBosattIRiketVilkårResultatForFinnmarkOgSvalbardtillegg(
                    personResultat = personResultat,
                    adresserForPerson = adresser,
                    behandling = behandling,
            ...
            // Assert
            assertThat(preutfylt).hasSize(2)
            assertThat(preutfylt).anySatisfy {
