    ...
    companion object {
        ...
        fun hentKombinasjonerOgBehandlingsResultat() =
            Stream.of(
                ...
                Arguments.of(Søknadsresultat.INNVILGET, Endringsresultat.ENDRING_UTEN_BELØPSENDRING, Opphørsresultat.OPPHØRT, Behandlingsresultat.INNVILGET_ENDRET_OG_OPPHØRT),
                Arguments.of(Søknadsresultat.INNVILGET, Endringsresultat.ENDRING_UTEN_BELØPSENDRING, Opphørsresultat.FORTSATT_OPPHØRT, Behandlingsresultat.INNVILGET_OG_ENDRET),
                Arguments.of(Søknadsresultat.INNVILGET, Endringsresultat.ENDRING_UTEN_BELØPSENDRING, Opphørsresultat.IKKE_OPPHØRT, Behandlingsresultat.INNVILGET_OG_ENDRET),
                ...
                Arguments.of(Søknadsresultat.AVSLÅTT, Endringsresultat.ENDRING_UTEN_BELØPSENDRING, Opphørsresultat.OPPHØRT, Behandlingsresultat.AVSLÅTT_ENDRET_OG_OPPHØRT),
                Arguments.of(Søknadsresultat.AVSLÅTT, Endringsresultat.ENDRING_UTEN_BELØPSENDRING, Opphørsresultat.FORTSATT_OPPHØRT, Behandlingsresultat.AVSLÅTT_OG_ENDRET),
                Arguments.of(Søknadsresultat.AVSLÅTT, Endringsresultat.ENDRING_UTEN_BELØPSENDRING, Opphørsresultat.IKKE_OPPHØRT, Behandlingsresultat.AVSLÅTT_OG_ENDRET),
                ...
                Arguments.of(Søknadsresultat.DELVIS_INNVILGET, Endringsresultat.ENDRING_UTEN_BELØPSENDRING, Opphørsresultat.OPPHØRT, Behandlingsresultat.DELVIS_INNVILGET_ENDRET_OG_OPPHØRT),
                Arguments.of(Søknadsresultat.DELVIS_INNVILGET, Endringsresultat.ENDRING_UTEN_BELØPSENDRING, Opphørsresultat.FORTSATT_OPPHØRT, Behandlingsresultat.DELVIS_INNVILGET_OG_ENDRET),
                Arguments.of(Søknadsresultat.DELVIS_INNVILGET, Endringsresultat.ENDRING_UTEN_BELØPSENDRING, Opphørsresultat.IKKE_OPPHØRT, Behandlingsresultat.DELVIS_INNVILGET_OG_ENDRET),
                ...
                Arguments.of(null, Endringsresultat.ENDRING_UTEN_BELØPSENDRING, Opphørsresultat.OPPHØRT, Behandlingsresultat.ENDRET_OG_OPPHØRT),
                Arguments.of(null, Endringsresultat.ENDRING_UTEN_BELØPSENDRING, Opphørsresultat.FORTSATT_OPPHØRT, Behandlingsresultat.ENDRET_OG_FORTSATT_OPPHØRT),
                Arguments.of(null, Endringsresultat.ENDRING_UTEN_BELØPSENDRING, Opphørsresultat.IKKE_OPPHØRT, Behandlingsresultat.ENDRET_UTBETALING),
