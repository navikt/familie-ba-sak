    ...
    fun `minimal oppfylt vilkårsvurdering ett barn skal gi utbetalinger etter satsendringer`() {
        ...
        val forventedeAndeler =
            listOf(
                ...
                barn får alt av 1310 i nov(2023)..des(2023),
                barn får alt av 1510 i jan(2024)..aug(2024),
                barn får alt av 1766 i sep(2024)..apr(2025),
                barn får alt av 1968 i mai(2025)..jan(2026),
    ...
    fun `minimal oppfylt vilkårsvurdering to barn skal gi utbetalinger etter satsendringer`() {
        ...
        val forventedeAndeler =
            listOf(
                ...
                barn1 får alt av 1310 i nov(2023)..des(2023),
                barn1 får alt av 1510 i jan(2024)..aug(2024),
                barn1 får alt av 1766 i sep(2024)..apr(2025),
                barn1 får alt av 1968 i mai(2025)..jan(2026),
                barn1 får alt av 2012 i feb(2026)..okt(2035),
                // barn 2
                ...
                barn2 får alt av 1310 i jul(2023)..des(2023),
                barn2 får alt av 1510 i jan(2024)..aug(2024),
                barn2 får alt av 1766 i sep(2024)..apr(2025),
                barn2 får alt av 1968 i mai(2025)..jan(2026),
    ...
    fun `minimal vilkårsvurdering ett barn og delt bosted`() {
        ...
        val forventedeAndeler =
            listOf(
                ...
                barn får alt av 1766 i mar(2024)..apr(2025),
                barn får alt av 1968 i mai(2025)..jan(2026),
    ...
    fun `vilkårsvurdering ett barn som dør samme måned som fylte 18`() {
        ...
        val forventedeAndeler =
            listOf(
                ...
                barn får alt av 1676 i jan(2022)..feb(2023),
                barn får alt av 1723 i mar(2023)..jun(2023),
                barn får alt av 1766 i jul(2023)..apr(2025),
                barn får alt av 1968 i mai(2025)..jan(2026),
                barn får alt av 2012 i feb(2026)..nov(2037),
            )
    ...
    fun `skal opprette riktige satser for barn og søker ved utvidet barnetrygd`() {
        ...
        val forventedeAndeler =
            listOf(
                ...
                barn får 1766 i jul(2023)..apr(2025),
                barn får 1968 i mai(2025)..jan(2026),
                barn får 2012 i feb(2026)..nov(2036),
                søker får 970 i jan(2019)..feb(2019),
                søker får 1054 i mar(2019)..feb(2023),
                søker får 2489 i mar(2023)..jun(2023),
                søker får 2516 i jul(2023)..jan(2026),
