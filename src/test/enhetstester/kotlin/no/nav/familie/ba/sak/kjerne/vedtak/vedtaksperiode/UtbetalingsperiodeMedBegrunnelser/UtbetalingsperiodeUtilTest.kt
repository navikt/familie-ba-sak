...
class UtbetalingsperiodeUtilTest {
    ...
    fun `Skal splitte på utdypende vilkårsvurdering når det flytter seg fra ett barn til et annet`() {
        ...
        val vilkårResultatBorMedSøkerMedUtdypendeVilkårsvurderingBarn1 =
            VilkårResultat(
        ...
        val vilkårResultatBorMedSøkerUtenUtdypendeVilkårsvurderingBarn1 =
            VilkårResultat(
                personResultat = personResultatBarn1,
        ...
        val resterendeVilkårForBarn =
            Vilkår.hentVilkårFor(PersonType.BARN, fagsakType = FagsakType.NORMAL, behandlingUnderkategori = BehandlingUnderkategori.ORDINÆR).mapNotNull {
                if (it == Vilkår.BOR_MED_SØKER) null else lagVilkårResultat(vilkår = it, fom = mars2020.minusMonths(1), tom = juli2020)
            }

        val vilkårResultaterBarn1 =
            listOf(
        ...
        val vilkårResultatBorMedSøkerMedUtdypendeVilkårsvurderingBarn2 =
            VilkårResultat(
        ...
        val vilkårResultatBorMedSøkerUtenUtdypendeVilkårsvurderingBarn2 =
            VilkårResultat(
                personResultat = personResultatBarn2,
                periodeFom = mai2020.førsteDagIInneværendeMåned(),
                periodeTom = juli2020.sisteDagIInneværendeMåned(),
    ...
    fun `Skal lage splitt i vedtaksperioder med der ulikt regelverk er brukt`() {
        ...
        fun nasjonaltVilkår(vilkårType: Vilkår): VilkårResultat =
            VilkårResultat(
