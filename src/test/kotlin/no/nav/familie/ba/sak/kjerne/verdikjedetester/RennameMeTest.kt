...
class RennameMeTest(
    ...
    fun `TODO renname me hente alle gjeldene behandlinger med småbarnstillegg opphør denne måneden`() {
        ...
        val barnFødselsdato1: LocalDate = LocalDate.now().minusYears(16)
        ...
        val beh2 = lagFullførtBehandling(
            fagsak = fagsak1,
        ...
        val barnFødselsdato2: LocalDate = LocalDate.now().minusYears(15)
        ...
        val beh4 = lagFullførtBehandling(
            fagsak = fagsak2,
            opphørAvSmåbarnstilleggNå = true,
            personScenario = personScenario2,
            barnFødselsdato = barnFødselsdato2,
        ...
        val barnFødselsdato3: LocalDate = LocalDate.now().minusYears(14)
        val personScenario3 = lagScenario(barnFødselsdato3)
        val fagsak3: RestMinimalFagsak = lagFagsak(personScenario = personScenario3)
        val beh5 = lagFullførtBehandling(
            fagsak = fagsak3,
            opphørAvSmåbarnstilleggNå = false,
            personScenario = personScenario3,
            barnFødselsdato = barnFødselsdato3,
            behandlingType = BehandlingType.FØRSTEGANGSBEHANDLING
        )
        val beh6 = lagFullførtBehandling(
            fagsak = fagsak3,
            opphørAvSmåbarnstilleggNå = false,
            personScenario = personScenario3,
            barnFødselsdato = barnFødselsdato3,
        ...
        val behandlinger: List<Behandling> =
            behandlingService.hentAlleBehandlingerMedOpphørSmåbarnstilleggInneværendeMåned()

        assertTrue(behandlinger.size == 2)
    }
