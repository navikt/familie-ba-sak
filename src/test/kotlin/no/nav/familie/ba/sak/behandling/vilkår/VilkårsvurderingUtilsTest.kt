...
class VilkårsvurderingUtilsTest() {
    ...
    private fun sorterListe(liste: List<VilkårResultat>): List<VilkårResultat> {
    ...
    fun `periode erstattes dersom en periode med overlappende tidsintervall legges til`() {
        var restVilkårResultat = RestVilkårResultat(2, vilkår, resultat,
                LocalDate.of(2010, 6, 2), LocalDate.of(2011, 9, 1),
                "")
        var gyldigVilkårListe = VilkårsvurderingUtils.endreVurderingForPeriodePåVilkår(vilkårResultater,
                restVilkårResultat)
    ...
    fun `fom-dato flyttes korrekt`() {
        var nyttResultat = VilkårResultat(1, personResultat, vilkår, resultat,
                LocalDate.of(2010, 5, 17), LocalDate.of(2010, 7, 1),
                "")
        var restVilkårResultat = RestVilkårResultat(1, vilkår, resultat,
                LocalDate.of(2010, 5, 17), LocalDate.of(2010, 7, 1),
                "")
        var vilkårResultater: List<VilkårResultat> = listOf(vilkårResultat1, vilkårResultat2, vilkårResultat3,
                nyttResultat)

        var gyldigVilkårListe = VilkårsvurderingUtils.endreVurderingForPeriodePåVilkår(vilkårResultater,
                restVilkårResultat)
        var vilkårMedEndretFomDato = gyldigVilkårListe.find {
            it.periodeFom ==
