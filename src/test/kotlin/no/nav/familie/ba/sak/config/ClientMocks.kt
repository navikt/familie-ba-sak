...
class ClientMocks {
    ...
    companion object {
        ...
        private val barnFødselsdatoer = arrayOf(
            ...
            LocalDate.now().withDayOfMonth(20).minusYears(4)
        )
        val barnFnr = arrayOf(
            barnFødselsdatoer[0].tilddMMyy() + "50033",
            barnFødselsdatoer[1].tilddMMyy() + "50033", barnFødselsdatoer[2].tilddMMyy() + "50033"
        )
