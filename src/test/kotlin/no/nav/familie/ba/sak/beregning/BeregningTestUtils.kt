...
fun lagTestUtbetalingsoppdragForFGBMedEttBarn(personIdent: String,
                                              fagsakId: String,
                                              behandlingId: Long,
...
fun lagTestUtbetalingsoppdragForFGBMedToBarn(personIdent: String,
                                             fagsakId: String,
                                             behandlingId: Long,
                                             vedtakDato: LocalDate,
...
fun lagTestUtbetalingsoppdragForOpphørMedToBarn(personIdent: String,
                                                fagsakId: String,
                                                behandlingId: Long,
                                                vedtakDato: LocalDate,
                                                datoFomBarn1: LocalDate,
...
fun lagTestUtbetalingsoppdragForRevurderingMedToBarn(personIdent: String,
                                                     fagsakId: String,
                                                     behandlingId: Long,
                                                     forrigeBehandlingId: Long,
                                                     vedtakDato: LocalDate,
                                                     ...
                                                     datoFomBarn2: LocalDate,
                                                     datoTomBarn2: LocalDate): Utbetalingsoppdrag {
    return Utbetalingsoppdrag(
            Utbetalingsoppdrag.KodeEndring.NY,
            "BA",
            fagsakId,
