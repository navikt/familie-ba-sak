...
class SaksstatistikkConverterTest {
    ...
    fun `konverter behandling 2_0_20201217113247_876a253 til 2_0_20210427132344_d9066f5`() {
        val behandlingerSomSkalKonverteresTilNyesteKontrakt = ClassPathResource("dvh/behandling").file.listFiles()
        assertThat(behandlingerSomSkalKonverteresTilNyesteKontrakt).hasSize(4)
