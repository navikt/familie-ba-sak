...
class OppgaveBeskrivelseTest {
    ...
    fun `hentBegrunnelseFraFiltreringsregler() skal returnere null dersom ingen regler feiler`() {
        val testEvaluering = testSpesifikasjoner.evaluer(
            TestFaktaForFiltreringsregler(
                barnetLever = true,
                morLever = true,
                morErOver18År = true
            )
    ...
    fun `hentBegrunnelseFraVilkårsvurdering() skal returnere riktig beskrivelse basert på vilkårsrekkefølgen`() {
        ...
        every { behandlingResultatRepositoryMock.findByBehandlingAndAktiv(any()) } returns genererBehandlingResultat(
            ...
            barnasVilkår = TestFaktaForBarnasVilkår(
                under18År = false,
                borMedSøker = true,
    ...
    companion object {
        ...
        private fun genererBehandlingResultat(
            søkersVilkår: TestFaktaForSøkersVilkår,
            barnasVilkår: TestFaktaForBarnasVilkår
        ): Vilkårsvurdering {
        ...
        val søker = Person(
            type = PersonType.SØKER, fødselsdato = LocalDate.of(1990, 1, 12), kjønn = Kjønn.KVINNE,
        ...
        val barn = Person(
            type = PersonType.BARN, fødselsdato = LocalDate.of(2019, 1, 12), kjønn = Kjønn.KVINNE,
