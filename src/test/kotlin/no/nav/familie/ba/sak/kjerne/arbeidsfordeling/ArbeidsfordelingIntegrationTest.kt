        ...
        stegService.håndterSøknad(
            ...
            RestRegistrerSøknad(
                søknad = lagSøknadDTO(
                    ArbeidsfordelingMockConfiguration.SØKER_FNR,
                    listOf(
                        ArbeidsfordelingMockConfiguration.BARN_UTEN_DISKRESJONSKODE,
...
class ArbeidsfordelingMockConfiguration {
    ...
    fun mockPersonopplysningsService(): PersonopplysningerService {
        ...
        every { personopplysningerServiceMock.hentStatsborgerskap(any()) } returns listOf(
            Statsborgerskap(
                land = "NOR",
                LocalDate.now(),
                LocalDate.now()
        ...
        every { personopplysningerServiceMock.hentBostedsadresseperioder(any()) } returns listOf(
        ...
        every { personopplysningerServiceMock.hentOpphold(any()) } returns listOf(
            Opphold(
