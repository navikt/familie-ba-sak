...
internal class CharTidslinje(private val tegn: String, private val startMåned: MånedTidspunkt) :
    ...
    override fun lagPerioder(): Collection<Periode<Char, YearMonth>> {
...
fun String.tilCharTidslinje(fom: YearMonth): Tidslinje<Char, YearMonth> =
    CharTidslinje(this, Tidspunkt.Companion.med(fom)).komprimer()

fun String.tilCharTidslinje(fom: MånedTidspunkt): Tidslinje<Char, YearMonth> = CharTidslinje(this, fom).komprimer()
