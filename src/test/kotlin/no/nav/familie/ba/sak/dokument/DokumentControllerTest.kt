...
class DokumentControllerTest(
    ...
    fun `Test hent html vedtak`() {
        ...
        every { mockDokumentService.hentHtmlVedtakForBehandling(any()) } returns Ressurs.success("mock_html")
    ...
    fun `Hent HTML vedtaksbrev Negative'`() {
        val failRess = dokumentService.hentHtmlVedtakForBehandling(100)
