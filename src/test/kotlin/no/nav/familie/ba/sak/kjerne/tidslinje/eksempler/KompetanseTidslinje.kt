...
class KompetanseTidslinje(
    ...
    override fun fraOgMed() = kompetanser.map { it.fom.tilTidspunktEllerUendeligLengeSiden { it.tom!! } }.minOrNull()!!
    override fun tilOgMed() = kompetanser.map { it.tom.tilTidspunktEllerUendeligLengeTil { it.fom!! } }.maxOrNull()!!
